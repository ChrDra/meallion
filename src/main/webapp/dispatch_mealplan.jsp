        ...
        <body>
            ...
            <div class="container main-page-container"> 
                ...
                <%
                    if(!"saved".equals((String)request.getAttribute("mealplan_status"))){
                %>  
                <button class="btn btn-primary" id="mealplan_save_section_open_button">Menü speichern <span id="save_button_glyph" class="glyphicon glyphicon-chevron-down"></span></button>
                <div id="mealplan_save_section">
                    <h3>Name</h3>
                    <div class="input-group">
                        <input id="mealplan_save_section_input" size="80" maxlength="80" type="text" placeholder="Gib hier einen Namen Deines Menüs ein" class="form-control">
                        
                    </div>
                    <div id="mealplan_save_section_name_exists_already" class="alert alert-danger">
                        Ein Menü mit diesem Namen existiert bereits!
                    </div>
                    <h3>Beschreibung</h3>
                    ...
                    <div id="mealplan_name_already_exits_label"><span class="label label-warning">Ein Menü mit diesem Namen existiert bereits!</span></div>
                <%
                    }
                %>
